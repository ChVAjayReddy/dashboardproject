      ...
      <div>
            ...
            <div id="sidebarwidgets"key={index}>
              <button
                ...
                style={{
                  ...
                  height: "50px",
                  border: "none",
                  borderBottom: index === tab ? "2px solid blue" : "2px solid grey",
                }}
              >
            ...
            <div id="sidebarwidget"key={index}>
              {tab === index &&
                category.widgets.map((widget, index) => (
                  <div
                    key={index}
                    style={{ border:"1px solid grey", width:"98%", margin:"1%" ,display:"flex", alignItems:"center",color:"#0e0eb0"}}
                  >
                    <input
                      type="checkbox"
        ...
        <div id="sidebarbuttons">
          <button
            ...
            style={{backgroundColor:"transparent",cursor:"pointer",color:"rgb(54, 54, 149)",borderRadius:"5px",padding:"10px"}}
          >
            Cancel
          </button>
          <button
            ...
            style={{backgroundColor:"rgb(54, 54, 149)",cursor:"pointer",color:"white",borderRadius:"5px",padding:"10px"}}
          >
            Confirm
          </button>
        </div>
